...
public class TurtleSoup {
    ...
    /**
     * Determine inside angle of a regular polygon.
     * 
     * There is a simple formula for calculating the inside angle of a polygon;
    ...
    /**
     * Determine number of sides given the size of interior angle of a regular polygon.
     * 
     * There is a simple formula for this; you should derive it and use it here.
     * Make sure you *properly round* the answer before you return it (see java.lang.Math).
     * HINT: it is easier if you think about the exterior angle.
     * 
     * @param angle size of interior angle in degrees, where 0 < angle < 180
    ...
    public static List<Double> calculateBearings(List<Integer> xCoords, List<Integer> yCoords) {
        ...
        for (int i = 1; i < length; i++) {
            ...
            answer.add(calculateBearingToPoint(currentBearing, currentX, currentY, targetX, targetY));
            currentBearing = answer.get(i - 1);
            currentX = targetX;
            currentY = targetY;
        }
        return answer;
    ...
    public static void drawPersonalArt(Turtle turtle) {
    	for (int i = 0 ; i < 1000; i++) {
            ...
            switch ((i/16) % 10) {
                ...
                case 1:turtle.color(PenColor.BLACK);break;
                case 2:turtle.color(PenColor.RED);break;
                case 3:turtle.color(PenColor.BLACK);break;
                case 4:turtle.color(PenColor.RED);break;
                case 5:turtle.color(PenColor.RED);break;
                case 6:turtle.color(PenColor.BLACK);break;
                case 7:turtle.color(PenColor.RED);break;
                case 8:turtle.color(PenColor.BLACK);break;
                case 9:turtle.color(PenColor.RED);break;
            }
            turtle.turn(100);
        }
    }
